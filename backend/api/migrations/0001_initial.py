# Generated by Django 5.0.1 on 2024-01-09 14:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street_address', models.CharField(default=None, max_length=256, null=True)),
                ('province', models.CharField(default=None, max_length=128, null=True)),
                ('district', models.CharField(default=None, max_length=128, null=True)),
                ('postal_code', models.CharField(default=None, max_length=5, null=True)),
                (
                    'created_at',
                    models.DateTimeField(auto_now_add=True, db_default=django.db.models.functions.datetime.Now()),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'genre',
                    models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.genre'),
                ),
            ],
            options={
                'db_table': 'products',
